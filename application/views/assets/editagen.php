      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="card">
            ...
            <div class="card-body table-responsive">
              <form action="main/updateagen/<?php echo $id; ?>" id="save" method="post" enctype="multipart/form-data">
                <table class="table">
                  <tr>
                    <td>Nama Agen</td>
                    <td>
                      <input type="text" value="<?php echo $row->a ?>" class="form-control" name="a">
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" value="<?php echo $row->b ?>" class="form-control" name="b">
                    </td>
                  </tr>
                  <tr>
                    <td>Provinsi</td>
                    <td>
                      <input type="text" value="<?php echo $row->c ?>" class="form-control" name="c">
                    </td>
                  </tr>
                  <tr>
                    <td>Kecamatan</td>
                    <td>
                      <input type="text" value="<?php echo $row->d ?>" class="form-control" name="d">
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>Harga</td>
                    <td>
                      <input type="text" value="<?php echo $row->f ?>" class="form-control" name="f">
                    </td>
                  </tr>
                  <tr>
                    <td>Jam Operasional</td>
                    <td>
                      <input type="time" value="<?php echo $row->g ?>" class="form-control" name="g">
                    </td>
                  </tr>
                  <tr>
                    <td>Ukuran Gas</td>
                    <td>
                      <input type="text" value="<?php echo $row->h ?>" class="form-control" name="h">
                    </td>
                  </tr>
                  <tr>
                    <td>Jenis</td>
                    <td>
                      <input type="text" value="<?php echo $row->i ?>" class="form-control" name="i">
                    </td>
                  </tr>
                  <tr>
                    <td>Alamat</td>
                    <td>
                      <input type="text" value="<?php echo $row->k ?>" class="form-control" name="k">
                    </td>
                  </tr>
                  <tr>
                    <td>Foto / Gambar</td>
                    <td>
                      <center>
                        <img id="blah" class='img-fluid mb-3' width='280' src="image/<?php echo $row->j ?>" alt="your image" />
                      </center>
