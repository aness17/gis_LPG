    ...
    <section class="breadcrumbs">
        <div class="container">
            <ol>
                ...
                <li>Peta Sebaran Agen LPG Pekanbaru Filtering Harga</li>
            </ol>
            <h2>Peta Sebaran Agen LPG Pekanbaru Filtering Harga</h2>
        </div>
    ...
    <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
            <header class="section-header">
                <p>Filtering harga</p>
                <form name="myForm" method="POST" action="home/harga">
                <select name="filterHarga" id="filterHarga" onchange="filtering()">
                <option value="" disabled selected>--Pilih Harga dan Ukuran--</option>    
                <?php foreach($harga as $row) { ?>
                    <option value="<?=$row->harga?>-<?=$row->ukuran?>" <?php if ($filterHarga==$row->harga."-".$row->ukuran) {?> selected <?php } ?>><?=$row->harga?>-<?=$row->ukuran?></option>
                    <?php } ?>
                </select>
...
<script>
    ...
    function filtering(){
        var el = document.getElementById("filterHarga");
        ...
        console.log(document.getElementById("ukuran").value);
