        ...
        <div class="container" data-aos="fade-up">
            <header class="section-header">
                ...
                <form name="myForm" method="POST" action="home/kecamatan">
                    <select name="filterkecamatan" id="filterkecamatan" onchange="filtering()">
...
<script>
    ...
    function filtering() {
        var el = document.getElementById("filterkecamatan");
        var filterValue = el.value;

        document.getElementById("kecamatan").value = filterValue;
        console.log(document.getElementById("kecamatan").value);
